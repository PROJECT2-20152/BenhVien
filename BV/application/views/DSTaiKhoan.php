    ...
    <head>
        ...
        <style>
            ...
            input[type=text] {
                ...
                background-image: url('timkiem.png');
            ...
            <div class="row content">
                ...
                <div class="col-sm-8 text-left"> 
                    <div class="container"> 
                        ...
                        <form action="<?php echo site_url('TaiKhoan_Controller/search');?>" method = "post">
                            ...
                            <tbody>
                                ...
                                foreach ($data_get as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal1" href="<?php echo site_url('TaiKhoan_Controller/detail/' . $row->idTaiKhoan); ?>" ><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> Chi tiết</button></a>
